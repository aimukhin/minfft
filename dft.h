...
struct dft_aux *mkaux_complex_1d(int N);
struct dft_aux *mkaux_complex_2d(int N1, int N2);
struct dft_aux *mkaux_complex_3d(int N1, int N2, int N3);
struct dft_aux *mkaux_complex(int d, int *Ns);
struct dft_aux *mkaux_t2t3_1d(int N);
struct dft_aux *mkaux_t2t3_2d(int N1, int N2);
struct dft_aux *mkaux_t2t3_3d(int N1, int N2, int N3);
struct dft_aux *mkaux_t2t3(int d, int *Ns);
struct dft_aux *mkaux_t4_1d(int N);
struct dft_aux *mkaux_t4_2d(int N1, int N2);
struct dft_aux *mkaux_t4_3d(int N1, int N2, int N3);
