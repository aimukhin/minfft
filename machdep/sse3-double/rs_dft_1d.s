# Double precision split-radix (2/4) DIF forward FFT
# Arch: x86-64 SSE3
# ABI: SysV AMD64
#
...
L:	# loop N/4 times (N>=16) with 2 iterations unrolled
	...
	subpd		%xmm3,%xmm2		# xmm2=t2-t3
	addpd		%xmm3,%xmm4		# xmm4=t2+t3
	movapd		%xmm10,%xmm12		# -/-
	subpd		%xmm11,%xmm10		# -/-
	addpd		%xmm11,%xmm12		# -/-
	# store t[N/4+n]
	...
	push		%r8
	push		%r9
	# call rs_dft_1d(N/2,t,t,y,2sy,e+N/2)
	call		rs_dft_1d
	pop		%r9			# r9=e+N/2
	pop		%r8			# r8=2sy
	pop		%rcx			# rcx=y
	...
	push		%r8
	push		%r9
	# call rs_dft_1d(N/4,t+N/2,t+N/2,y+sy,4sy,e+3N/4)
	call		rs_dft_1d
	pop		%r9			# r9=e+3N/4
	pop		%r8			# r8=4sy
	pop		%rcx			# rcx=y+sy
	...
	# call rs_dft_1d(N/4,t+3N/4,t+3N/4,y+3sy,4sy,e+3N/4)
	jmp		rs_dft_1d
	# we're done
...
T4:	# N==4
	...
	subpd		%xmm3,%xmm2		# xmm2=y[sy]
	subpd		%xmm1,%xmm4		# xmm4=y[2*sy]
	addpd		%xmm3,%xmm5		# xmm5=y[3*sy]
	movapd		%xmm0,(%rcx)		# store y[0]
	movapd		%xmm2,(%rcx,%r8)	# store y[sy]
...
T8:	# N==8
	...
	subpd		%xmm3,%xmm2		# xmm2=t01
	subpd		%xmm1,%xmm4		# xmm4=t02
	addpd		%xmm3,%xmm5		# xmm5=t03
	...
	subpd		%xmm11,%xmm10		# xmm10=t11
	subpd		%xmm9,%xmm12		# xmm12=t12
	addpd		%xmm11,%xmm13		# xmm13=t13
	...
	xorpd		si(%rip),%xmm12		# change sign of Im
...
# sign-flipping mask for imaginary part
si:	.quad		0x0000000000000000
