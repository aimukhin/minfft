...
L:	@ main loop
	...
	vsub.f32	d0,d20,d22		@ d0=(t2-t3)_r,(t2-t3)'_r
	vadd.f32	d1,d20,d22		@ d1=(t2+t3)_r,(t2+t3)'_r
	vsub.f32	d2,d21,d23		@ d2=(t2-t3)_i,(t2-t3)'_i
	vadd.f32	d3,d21,d23		@ d3=(t2+t3)_i,(t2+t3)'_i
	@ load exponents
	vld1.32		{q2-q3},[r5]!
	...
	@ call rs_dft_1d(N/2,t,t,y,2*sy,e+N/2)
	bl		rs_dft_1d
	...
	push		{r0-r3}			@ save registers
	push		{r4-r5}			@ pass sy and e
	@ call rs_dft_1d(N/4,t+N/2,t+N/2,y+sy,4*sy,e+3*N/4)
	bl		rs_dft_1d
	pop		{r4-r5}			@ restore sy and e
	pop		{r0-r3}			@ restore other parameters
	...
	push		{r4-r5}			@ pass sy and e
	@ call rs_dft_1d(N/4,t+3*N/4,t+3*N/4,y+3*sy,4*sy,e+3*N/4)
	bl		rs_dft_1d
...
T8:	@ save NEON registers
	...
	vsub.f32	q1,q6,q7		@ q1=t01,t11
	vsub.f32	d4,d8,d10
	vsub.f32	s10,s19,s23
	vsub.f32	s11,s22,s18		@ q2=t02,-I*t12
	vadd.f32	q3,q6,q7		@ q3=t03,t13
	@ multiply t11 by e1
	ldr		r2,=e
	vld1.32		{d8},[r2]!		@ d8=e1
	vmul.f32	s18,s6,s16
